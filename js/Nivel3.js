...
export class Nivel3 extends Phaser.Scene {
    ...
    create() {
        ...
        this.changeScenePoint = this.add.rectangle(800, 100, 50, 200, 0x0000ff, 0); // x, y, width, height son los parámetros de la posición y tamaño
        ...
        //Añadir Enemigos
        this.enemigo1 = new Puton(this, 535, 300);
    ...
    onOverlapChangeScene(player, changeScenePoint) {
        this.scene.start('Nivel4', {player: this.player}); // Cambia a la nueva escena
    }
