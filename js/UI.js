export default class UI extends Phaser.GameObjects.Container {
    constructor(scene, player){
        ...
        for(let i = 0; i < heartsCount; i++){
            //const heartX = (scene.cameras.main.widht - heartsCount * distanceBetweenhearts) / 2;
            const heart = this.scene.add.image( 200 + distanceBetweenhearts, 100, 'heart');
        ...
        this.icon = this.scene.add.image( 125, 70, this.iconPersonalityId + '_icon');
